				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
							<!-- listkey 相当于select标签中的value值，而listvalue相当于option标签的文本
							所以通过parentId传过去的值就是listKey的值！！ -->
								<s:select name="parentId" list="#departmentList"
									cssclass="SelectStyle" listKey="id" listValue="name"
									headerKey="-1" headerValue="==请输入上级部门名称==">
								</s:select>
							</td>
						</tr>
						<tr>
