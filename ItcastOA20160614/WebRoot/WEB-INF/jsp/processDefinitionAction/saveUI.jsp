...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="processDefinition_add" method="post" enctype="multipart/form-data">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="file" name="upload" class="InputStyle" required="required" accept="application/x-zip-compressed" style="width:450px;" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
